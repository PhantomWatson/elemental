...
<section class="about">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			Elemental is based on <strong>realistic situations and provides realistic training</strong>.
		</div>
...
<section class="about">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			Elemental is grounded in <a href="http://www.skhquest.com/">To-Shin Do</a>, a martial art that <strong>accounts for the circumstances people face as well as the way they feel about the threat they are facing.</strong>
		</div>
		<div class="panel-body">
			<p>
				To-Shin Do is an outgrowth of the ninja arts, and the ninja utilize a problem-solving paradigm that is grounded in 4 elements: earth, water, fire, and wind.  This approach allows a person to react to a situation based upon how they are feeling:
			</p>
			<ul class="list-group">
