...
To access the Student Review Module, visit <?php echo $review_module_link; ?>.

If you have any questions about the material covered in your course, your instructor can be reached at <?php echo $instructor_email; ?>. If you have any trouble using the website, please let us know through the contact form at <?php echo $contact_url; ?> or by emailing <?php echo Configure::read('admin_email'); ?>